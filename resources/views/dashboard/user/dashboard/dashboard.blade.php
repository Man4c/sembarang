    ...
    <div class="sidebar">
        <div class="main-sidebar">
            <div class="content">
                ...
                <div class="main-con">
                    <a href="{{ route('udashboard') }}" class="active">
                        <i class="fa-solid fa-house"></i>
                        <h3>Dashboard</h3>
                    </a>
                    {{-- <a href="{{ route('upelanggan') }}">
        ...
        <div class="main-body">
            ...
            {{-- <div class="tot-unit">
                <div class="unit-content">
                    ...
                    <div class="icon" style="background-color: #d2fae5;">
                        <i class="fa-solid fa-gamepad" style="color: #059668;"></i>
                    </div>
                </div>
            </div> --}}
            <div class="tot-unit">
